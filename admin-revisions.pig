...
/* get users */
usersToLookAt = LOAD '/data/CMU/hcii/wikipedia/20110317/rfa_candidate_name_only.txt' USING PigStorage('\t') AS (username:chararray);
...
STORE revs INTO '/data/CMU/hcii/wikipedia/20110317/rfa_revisions.out' USING PigStorage('\t');
